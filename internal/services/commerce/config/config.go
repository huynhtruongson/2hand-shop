...
// Config aggregates all sub-configuration structs for the commerce service.
type Config struct {
	...
	Stripe   StripeConfig   `mapstructure:",squash"`
}

// StripeConfig holds the Stripe API settings.
type StripeConfig struct {
	APIKey        string `mapstructure:"stripe_api_key"`
